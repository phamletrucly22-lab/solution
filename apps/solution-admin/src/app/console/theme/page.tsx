  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-black">테마·UI</h1>
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="rounded-lg border border-amber-700/60 bg-[#3182f6]/5 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-amber-900/30 disabled:cursor-not-allowed disabled:opacity-40"
          >
            미리보기 (새 탭)
          </button>
        </div>
      ...
      {postCreateHint && detail.previewPort != null && (
        <div className="rounded-xl border border-[#3182f6]/20 bg-[#3182f6]/5 px-4 py-4 text-sm">
          <p className="font-medium text-gray-700">플랫폼을 막 만드셨다면</p>
          <p className="mt-2 text-gray-500">
            로컬에서 미리보기를 켜려면 터미널에서 아래 중 하나를 실행하세요. (웹
            콘솔은 보안상 PC에 프로세스를 대신 켜 줄 수 없습니다.)
          </p>
          <div className="mt-3 flex flex-wrap items-center gap-2">
            <code className="block max-w-full overflow-x-auto rounded bg-white px-3 py-2 font-mono text-xs text-gray-700/90">
              {stackCmd}
            </code>
            <button
              type="button"
          ...
          {copyMsg && (
            <p className="mt-2 text-xs text-emerald-600/90">{copyMsg}</p>
          )}
        </div>
      )}
      ...
      {detail.previewPort != null && (
        <div className="rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-500">
          <p>
            ...
            <code className="rounded bg-white px-1.5 py-0.5 text-[#3182f6]">
              {detail.previewPort}
            </code>
        ...
        <section className="space-y-4">
          ...
          <label className="block text-sm text-gray-500">
            ...
            <input
              ...
              className="mt-2 h-10 w-full max-w-[12rem] cursor-pointer rounded border border-gray-300 bg-white"
            />
          </label>
          <label className="block text-sm text-gray-500">
            사이트 이름
            <input
              ...
              className="mt-1 w-full rounded border border-gray-300 bg-white px-3 py-2 text-black"
            />
          </label>
          <label className="block text-sm text-gray-500">
            로고 URL (선택)
          ...
          <label className="block text-sm text-gray-500">
            ...
            <textarea
              ...
              rows={4}
              className="mt-1 w-full rounded border border-gray-300 bg-white px-3 py-2 font-mono text-sm text-black"
            />
          </label>
        </section>
