...
export default function ConsoleUsersPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-semibold text-gray-900">운영 계정 · 회원</h1>
      ...
      <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
        ...
        <div className="mt-3 flex flex-wrap gap-4 text-sm">
          <button
            type="button"
            onClick={() => setTab("masters")}
            className="flex items-center gap-2 text-gray-700 hover:text-[#3182f6]"
          >
            <span className="inline-block h-2 w-2 rounded-full bg-violet-500" />
            총판 <span className="font-mono text-gray-900">{masters.length}</span>
            {totalSplit > 0 && (
          ...
          >
            ...
            일반 유저{" "}
            <span className="font-mono text-gray-900">{endUsers.length}</span>
            {totalSplit > 0 && (
        ...
        >
          ...
          <label className="text-xs text-gray-500">
            ...
            <input
              ...
              className="mt-1 block w-48 rounded border border-gray-200 bg-white px-2 py-1.5 font-mono text-sm text-gray-900"
              required
              minLength={3}
              autoComplete="off"
            />
          ...
          <label className="text-xs text-gray-500">
            ...
            <input
              ...
              className="mt-1 block w-48 rounded border border-gray-200 bg-white px-2 py-1.5 text-sm text-gray-900"
            />
          </label>
          <label className="text-xs text-gray-500">
            비밀번호
            <input
              ...
              className="mt-1 block w-36 rounded border border-gray-200 bg-white px-2 py-1.5 text-sm text-gray-900"
              required
            />
          </label>
          <label className="text-xs text-gray-500">
            ...
            <select
              ...
              className="mt-1 block rounded border border-gray-200 bg-white px-2 py-1.5 text-sm text-gray-900"
            >
              {getStoredUser()?.role === "SUPER_ADMIN" && (
            ...
            <>
              <label className="text-xs text-gray-500">
                ...
                <input
                  ...
                  placeholder="비우면 자동"
                  className="mt-1 block w-28 rounded border border-gray-200 bg-white px-2 py-1.5 font-mono text-sm text-gray-900"
                />
              </label>
              <label className="text-xs text-gray-500">
                상위 총판(선택)
                <select
                  ...
                  className="mt-1 block max-w-[200px] rounded border border-gray-200 bg-white px-2 py-1.5 text-sm text-gray-900"
                >
              ...
              {parentMasterForCreate ? (
                <label className="text-xs text-gray-500">
                  ...
                  <input
                    ...
                    className="mt-1 block w-24 rounded border border-gray-200 bg-white px-2 py-1.5 font-mono text-sm text-gray-900"
                  />
                </label>
              ) : (
                <label className="text-xs text-gray-500">
          ...
          <button
            type="submit"
            disabled={creating}
            className="rounded bg-amber-600 px-3 py-2 text-sm font-medium text-white hover:bg-[#3182f6] disabled:opacity-50"
          >
            추가
          </button>
                ...
                {masters.length === 0 ? (
                  ...
                  masters.map((r) => {
                    ...
                    return (
                      <tr
                        key={r.id}
                        className={`cursor-pointer border-b border-gray-200/80 transition ${
                          sel ? "bg-violet-950/40" : "hover:bg-gray-50"
                        }`}
                        onClick={() =>
                      ...
                      >
                        ...
                        <td className="px-4 py-2 font-mono text-xs text-[#3182f6]/90">
                        ...
                        >
                          <button
                            type="button"
                            onClick={() => openMemo(r)}
                            className="text-xs text-violet-400 hover:text-[#3182f6] hover:underline"
                          >
            ...
            <div className="rounded-xl border border-violet-900/50 bg-violet-950/20 p-4">
              <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
                ...
                <button
                  ...
                  className="text-xs text-violet-400 hover:text-[#3182f6]"
                >
                  닫기
                </button>
              </div>
                  ...
                  <table className="w-full text-left text-sm">
                    ...
                    <tbody>
                      {childrenOfSelected.map((u) => (
                        <tr
                          key={u.id}
                          className="cursor-pointer border-b border-gray-200/80 hover:bg-gray-50"
                  ...
                  endUsers.map((r) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="max-w-[220px] truncate px-4 py-2 text-xs text-[#3182f6]/80">
                        ...
                        >
                          {parent ? (
                            <button
                              ...
                              className="text-left text-[#3182f6] hover:text-[#3182f6] hover:underline"
                            >
        ...
        <div className="space-y-2">
          ...
          <div className="overflow-x-auto rounded-xl border border-gray-200">
            <table className="w-full text-left text-sm">
              ...
              <tbody>
                {otherRoles.map((r) => (
                  <tr key={r.id} className="border-b border-gray-200/80">
                    <td className="px-4 py-2 text-gray-800">
                      {rowLoginLabel(r)}
                    </td>
                    <td className="px-4 py-2 text-gray-500">
      ...
      {referralCodeUser && canCreate && (
        <div
          ...
          aria-modal="true"
        >
          <div className="w-full max-w-md rounded-xl border border-gray-200 bg-gray-50 p-5 shadow-xl">
            ...
            <label className="mt-4 block text-sm text-gray-500">
              ...
              <input
                ...
                className="mt-1 w-full rounded-lg border border-gray-200 bg-white px-3 py-2 font-mono text-sm text-gray-900"
              />
            </label>
      ...
      {rateHist && canCreate && (
        <div
          ...
          aria-modal="true"
        >
          <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-xl border border-gray-200 bg-gray-50 p-5 shadow-xl">
            ...
            {rateHistLoading ? (
              ...
              rateHistComm.length === 0 ? (
                ...
                <table className="mt-4 w-full text-left text-xs">
                  ...
                  <tbody>
                    {rateHistComm.map((h) => (
                      <tr key={h.id} className="border-b border-gray-200/60">
      ...
      {commissionUser && canCreate && (
        <div
          ...
          aria-modal="true"
        >
          <div className="max-h-[90vh] w-full max-w-md overflow-y-auto rounded-xl border border-gray-200 bg-gray-50 p-5 shadow-xl">
            <h2 className="text-lg font-semibold text-gray-900">
              총판 요율 (다단계)
            </h2>
            <p className="mt-1 font-mono text-xs text-gray-500">
      ...
      {memoUser && (
        <div
          ...
          aria-modal="true"
        >
          <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-xl border border-gray-200 bg-gray-50 p-5 shadow-xl">
